...
class ContextAnalyzer {
     ...
     */
    isInsideStringOrComment(document, position) {
     ...
     */
    extractScope(document, position) {
     ...
     */
    isValidCompletionPoint(document, position) {
